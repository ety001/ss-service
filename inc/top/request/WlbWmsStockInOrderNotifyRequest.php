...
class WlbWmsStockInOrderNotifyRequest
{
	...
	/** 
	 * 单据类型 302调拨入库单 504归还入库单  602 B2B入库单  501销退入库单 504换货入库单  601采购入库单  904其他入库单
	 **/
	private $orderType;
	...
	public function setBatchSendCtrlParam($batchSendCtrlParam)
	{
		$this->batchSendCtrlParam = $batchSendCtrlParam;
		$this->apiParas["batch_send_ctrl_param"] = $batchSendCtrlParam;
	}

	public function getBatchSendCtrlParam()
	{
